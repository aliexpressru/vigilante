...
public sealed class CollectionMetrics : Dictionary<string, object>
{
    ...
    public string? PrettySize
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.PrettySizeKey);
            }
            else
            {
                this[MetricConstants.PrettySizeKey] = value;
            }
        }
    }
    ...
    public long? SizeBytes
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.SizeBytesKey);
            }
            else
            {
                this[MetricConstants.SizeBytesKey] = value.Value;
            }
        }
    }
    ...
    public string? PrettyRamSize
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.PrettyRamSizeKey);
            }
            else
            {
                this[MetricConstants.PrettyRamSizeKey] = value;
            }
        }
    }
    ...
    public long? RamBytes
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.RamBytesKey);
            }
            else
            {
                this[MetricConstants.RamBytesKey] = value.Value;
            }
        }
    }
    ...
    public CollectionMemoryReportInfo? MemoryReport
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.MemoryReportKey);
            }
            else
            {
                this[MetricConstants.MemoryReportKey] = value;
            }
        }
    }
    ...
    public List<ShardDetails>? Shards
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.ShardsKey);
            }
            else
            {
                this[MetricConstants.ShardsKey] = value;
            }
        }
    }
    ...
    public List<OutgoingTransferInfo>? OutgoingTransfers
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.OutgoingTransfersKey);
            }
            else
            {
                this[MetricConstants.OutgoingTransfersKey] = value;
            }
        }
    }
    ...
    public Dictionary<string, string>? ShardStates
    {
        ...
        set {
            if (value is null)
            {
                Remove(MetricConstants.ShardStatesKey);
            }
            else
            {
                this[MetricConstants.ShardStatesKey] = value;
            }
        }
    }
