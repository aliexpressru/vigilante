...
public interface IClusterManager
{
    ...
    /// </summary>
    Task<(IReadOnlyList<CollectionInfo> CollectionInfos, bool IsTestData)> GetCollectionsInfoAsync(bool clearCache = false, CancellationToken cancellationToken = default);
