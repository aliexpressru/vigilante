    ...
    : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            if (request.SingleNode)
            {
                ...
                var success = await clusterManager.DeleteSnapshotAsync(
                    request.CollectionName,
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            var snapshotStream = await clusterManager.DownloadSnapshotWithFallbackAsync(
                request.NodeUrl!,
                request.CollectionName,
                request.SnapshotName,
                request.PodName,
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            var success = await clusterManager.RecoverCollectionFromUrlAsync(
                request.NodeUrl,
                request.CollectionName,
                request.SnapshotUrl,
